...
void main() async {
  ...
  final req = await client.getUrl(Uri.parse('$supabaseUrl/rest/v1/reservas?select=id,codigo_reserva,habitacion_id,estado,check_in_previsto,check_out_previsto,cantidad_huespedes,monto_total'));
